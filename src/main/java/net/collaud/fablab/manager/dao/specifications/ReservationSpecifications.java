package net.collaud.fablab.manager.dao.specifications;
...
import net.collaud.fablab.manager.data.MachineEO_;
import net.collaud.fablab.manager.data.ReservationEO;
import net.collaud.fablab.manager.data.ReservationEO_;
