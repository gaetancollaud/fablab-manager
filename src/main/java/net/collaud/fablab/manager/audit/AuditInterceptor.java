...
import static net.collaud.fablab.manager.data.type.AuditAction.DELETE;
import static net.collaud.fablab.manager.data.type.AuditAction.INSERT;
import static net.collaud.fablab.manager.data.type.AuditAction.UPDATE;
...
import static net.collaud.fablab.manager.data.type.AuditObject.USER;
