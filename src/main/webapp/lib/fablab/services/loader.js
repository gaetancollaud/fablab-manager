...
angular.module('Loader', [], function($provide) {
	$provide.factory('LoaderService', ['I18nService', 'btfModal', '$timeout', function(i18nService, btfModal, $timeout) {
		var loaderShown = 0;
		var shown = false;
		var modalService = {};
						...
						'<div class="modal-dialog">'+
							'<div class="modal-content">'+
								'<div class="modal-header">'+
									'<h4 class="modal-title" id="commonPopupLoadingPageTitle" i18n-key="common.loading.title"></h4>'+
								'</div> <div class="modal-body app-loader-body">'+
									'<p i18n-key="common.loading.text"></p>'+
